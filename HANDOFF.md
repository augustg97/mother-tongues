...
**Rounds 1–11 COMPLETE. LIVE:** https://augustg97.github.io/mother-tongues/ (stamp 1785573779)
...
Autonyms: 918 languages (12.0%) but **93.4% of speakers**. Anything from here is new scope. D3's per-file licence gate now exists in `build/fetch_gallery.py` and is the
...
- Last live deploy: **stamp 1785573779**, verified live (tree, texts and tiles confirmed)
